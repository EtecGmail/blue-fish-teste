    ...
    <header class="navbar" id="navbar" data-navbar data-open="false">
      <div class="navbar__inner">
        ...
        <div class="navbar__brand">
          <a href="{{ url('/') }}" class="navbar__logo" aria-label="Bluefish - Página inicial">
    ...
    <footer class="footer" role="contentinfo">
      <div class="footer__container">
        ...
        <section class="footer__section" aria-labelledby="footer-about">
          <h3 id="footer-about" class="footer__title">Sobre a Bluefish</h3>
          <p class="footer__description">
            Somos especialistas em produtos do mar de alta qualidade, oferecendo o melhor da pesca para nossos clientes com compromisso com a sustentabilidade e frescor garantido.
          </p>
        </section>
      ...
      <div class="footer__bottom">
        <p class="footer__copyright">
          &copy; {{ date('Y') }} Bluefish. Todos os direitos reservados.
        </p>
